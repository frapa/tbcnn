...
Therefore the data used in the article cannot be downloaded anymore,
...
for training. This data is available in the [belarus folder](/frapa/tbcnn/tree/master/belarus).
